...
//                     <GatsbyImage style={{position: 'absolute'}} image={this.props.menuItems[this.state.slide].node.backgroundImage.gatsbyImageData} alt={'Image for ' + slideStyles.slideTitle}/>
