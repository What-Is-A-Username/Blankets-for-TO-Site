            ...
            <div className={styles.linkContainer}>
                ...
                <div className={styles.link}>
                    <div className={styles.linkField}>
                        <p className={styles.linkCopyButton}>
                            <Link size={15} color='white'/>
                        </p>
                        <input type="text" value={this.props.location} id="linkAddress" readOnly />
                        <button className={this.state.linkCopied ? styles.linkFieldButtonClicked : styles.linkFieldButtonNormal} onClick={() => this.copyLink()}>{this.state.linkCopied ? "Copied!" : "Copy link"}</button>
                    </div>
                </div>
            </div>
        )
